...
class Factura{
    ...
    function __construct(){
        ...
        if(isset($_POST["producto"])){
            ...
            $this->p_cantidad= $obj["p_cantidad"] ?? 0;            
            $this->p_scancode= $obj["p_scancode"] ?? '';
            $this->p_precio= $obj["p_precio"] ?? 0;
    ...
    //Esta funcion se paso a la clase producto
    ...
    //         $param= array(':codigorapido'=>$this->codigo,':scancode'=>$this->scancode);
